...
export default function FinancialGoals() {
  ...
  const handleAddFinancialGoal = async () => {
    ...
    if (!newFinancialGoal.title || !newFinancialGoal.targetAmount || !newFinancialGoal.currentAmount || !newFinancialGoal.deadline) {
  ...
  const handleSave = async () => {
    ...
    try {
      await axios.put(DashboardAPIs.getDashboardFinancialGoalIdByDashboardId(dashboardId, editingId), editFormData, {
        headers: { Authorization: `Bearer ${jwtToken}` },
      });
  ...
  const handleDeleteFinancialGoal = async (goalId) => {
    ...
    const confirmDelete = window.confirm("Are you sure you want to delete this financial goal?");
    if (confirmDelete) {
      try {
        await axios.delete(DashboardAPIs.getDashboardFinancialGoalIdByDashboardId(dashboardId, goalId), {
          headers: { Authorization: `Bearer ${jwtToken}` },
        });
